...
class QualificationContractTests(unittest.TestCase):
    def test_full_runner_profiles_memory_and_linked_network(self):
        ...
        self.assertIn('"activity_probe": "discovery_seen"', runner)
        self.assertIn('peer_name = "gateway-board26"', runner)
        self.assertIn('"fdcan_rx"', runner)
        self.assertIn('"fdcan_tx_ok"', runner)
        self.assertIn('probe["minimum"] = 1', runner)
