...
static const launchcore_storage_layout_t layout = {
    .slot_a_base = ACTUATOR_SLOT_A_BASE,
    .slot_a_size = ACTUATOR_SLOT_A_SIZE,
    .slot_b_base = ACTUATOR_DELTA_BASE,
    .slot_b_size = ACTUATOR_DELTA_SIZE,
    .metadata0_base = ACTUATOR_METADATA0_BASE,
    .metadata1_base = ACTUATOR_METADATA1_BASE,
    ...
    .persistent_data_base = ACTUATOR_PERSIST_BASE,
    .persistent_data_size = ACTUATOR_PERSIST_SIZE,
...
{
    return addr >= ACTUATOR_VECTOR_TABLE &&
           addr < ACTUATOR_SLOT_A_BASE + ACTUATOR_SLOT_A_SIZE;
}
